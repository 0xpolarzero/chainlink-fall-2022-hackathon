    ...
    >
      <div className='drawer-content'>
        <Form form={form} layout='vertical' requiredMark={true}>
          ...
          {/* Make sure there is one field added by default */}
          <Form.List
            name='parties'
            initialValue={[{ partyAddress: userAddress }]}
          >
            {(fields, { add, remove }) => (
              <>
                {fields.map((field, i) => (
                    ...
                    <Form.Item
                      ...
                      rules={[
                        ...
                        // Make sure it's not the dead address
                        {
                          ...
                          message:
                            'You might want to use a different address...',
                          warningOnly: true,
                        },
                      ]}
                    >
                    ...
                    <Form.Item
                      ...
                      rules={[
                        ...
                        },
                        {
                          min: 4,
                          message:
                            'Twitter handle must be at least 4 characters',
                        },
                        {
                          max: 15,
                          message:
